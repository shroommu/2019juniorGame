	...
	public void Display()
	{
		...
		switch(elementManager.elementals.Count)
		{
			...
			case 1:
				...
				primaryElementGaugeImg.color = elementManager.elementals[0].GetComponent<ElementalController>().so_Elemental.elementMaterial.GetColor("_Tint");
			...
			case 2:
				...
				secondaryElementGaugeImg.color = elementManager.elementals[1].GetComponent<ElementalController>().so_Elemental.elementMaterial.GetColor("_Tint");
